...
class Screen extends _react.default.Component {
  ...
  render() {
    ...
    if (enabled && isPlatformSupported) {
      AnimatedNativeScreen = AnimatedNativeScreen || _reactNative.Animated.createAnimatedComponent(ScreensNativeModules.NativeScreen); // Filter out active prop in this case because it is unused and
