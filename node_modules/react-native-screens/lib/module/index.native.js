...
class Screen extends React.Component {
  ...
  render() {
    ...
    if (enabled && isPlatformSupported) {
      AnimatedNativeScreen = AnimatedNativeScreen || Animated.createAnimatedComponent(ScreensNativeModules.NativeScreen); // Filter out active prop in this case because it is unused and
